...
def set_logger_and_tracker(config):
    ...
    create_dirs(f"{config['results_dir']}{config['exp_name']}/")
    create_dirs(f"{config['results_dir']}{config['exp_name']}/Losses/")
    create_dirs(f"{config['results_dir']}{config['exp_name']}/Checkpoints/")
